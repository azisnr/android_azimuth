...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textSensorAzimuth = findViewById(R.id.label_azimuth);
        textSensorPitch = findViewById(R.id.label_pitch);
        textSensorRoll = findViewById(R.id.label_roll);

        sensorManager=(SensorManager) getSystemService(Context.SENSOR_SERVICE);
        sensorAccelerometer=sensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER);
        sensorAccelerometer=sensorManager.getDefaultSensor(Sensor.TYPE_MAGNETIC_FIELD);
    }
